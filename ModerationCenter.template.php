...
function template_unapproved_posts()
{
	...
	foreach ($context['unapproved_items'] as $item)
	{
		...
		echo '
				<div class="windowbg clear post-list-item">
					<div class="post-list-item-header">
						<div class="counter post-list-item-counter">', $item['counter'], '</div>
						<div class="topic_details post-list-item-header-content">
							...
							<span class="inline_details">
								<span>', icon('fas fa-user'), ' ', $item['poster']['link'], '</span>
								<span>', icon('far fa-clock'), ' ', $item['time'], '</span>
								<span>', icon('fas fa-folder'), ' ', $item['category']['link'], ' / ', $item['board']['link'], '</span>
							</span>
						</div>
					</div>
