...
<html', $context['right_to_left'] ? ' dir="rtl"' : '', '>
	...
	<body id="likes_popup">
		<div class="windowbg">
			<ul id="likes" class="like-item-container">';

	foreach ($context['likers'] as $liker => $like_details)
		echo '
				<li class="like-item">
					<div class="like-item-avatar">', $like_details['profile']['avatar']['image'], '</div>
					<div class="like_profile like-item-content">
						<div class="like-item-username">', $like_details['profile']['link_color'], '</div>
						<div class="like-item-details">
							<div class="like-item-group">', icon('fas fa-circle'), ' ', $like_details['profile']['group'], '</div>
							<div class="like-item-time like_time">', icon('far fa-clock'), ' ', $like_details['time'], '</div>
						</div>
					</div>
				</li>';
