...
function template_main()
{
	...
	$newPostsHTML = '
		...
		<div class="windowbg">
			...
			<div class="keyinfo">
				<span>
					<span>' . $txt['posted_by'] . '</span> %PosterName%
					<span>&nbsp;-&nbsp;%PostTime%&nbsp;&#187; <span class="new_posts" id="image_new_%PostID%">' . $txt['new'] . '</span></span>
				</span>';
	...
	if ($context['can_quote'])
		$newPostsHTML .= '
				<ul class="quickbuttons sf-js-enabled sf-arrows" id="msg_%PostID%_quote" style="touch-action: pan-y;">
					<li id="post_modify">
						<a href="#postmodify" onclick="return insertQuoteFast(%PostID%);" class="quote_button" title="' . $txt['quote'] . '"><span class="main_icons quote"></span></a>
					</li>
				</ul>';
			...
			if ($context['can_quote'])
				echo '
						<ul class="quickbuttons" id="msg_', $post['id'], '_quote">
							...
							<li id="post_modify"><a href="#postmodify" onclick="return insertQuoteFast(', $post['id'], ');" class="quote_button" title="', $txt['quote'], '"><span class="main_icons quote"></span></a></li>
						</ul>';
