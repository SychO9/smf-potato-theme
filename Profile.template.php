...
function template_profile_popup()
{
	...
	echo '
		<div class="profile_user_info dropdown-bar">
...
function template_alerts_popup()
{
	...
	// Unlike almost every other template, this is designed to be included into the HTML directly via $().load()
	echo '
		<div class="alert_bar dropdown-bar">
		...
		<div class="alerts_unread dropdown-resources', empty($context['unread_alerts']) ? ' dropdown-resources--empty' : '', '">';
