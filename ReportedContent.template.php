...
function template_reported_posts()
{
	...
	{
		echo '
			<div class="windowbg post-list-item">
				<div class="post-list-item-header">
					<div class="post-list-item-header-content">
		...
		echo '
				...
				<div class="post-list-item-content">
					<div class="post">', $report['body'], '</div>';
...
function template_reported_members()
{
	...
	{
		echo '
		<div class="generic_list_wrapper windowbg post-list-item">
			<div class="post-list-item-header">
				<div class="post-list-item-header-content">
					<h5 class="post-list-item-title">
